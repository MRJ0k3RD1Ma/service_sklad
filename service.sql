...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2025 at 07:58 PM
...
INSERT INTO `client` (`id`, `image`, `type_id`, `name`, `phone`, `phone_two`, `comment`, `balance`, `status`, `created`, `updated`, `register_id`, `modify_id`) VALUES
                                                                                                                                                                    ...
                                                                                                                                                                    (2, 'client/1758978404.3146.jpg', 1, 'Dilmurod', '(99)967-0395', '', '123213', '-600000.00', 1, '2025-09-07 16:24:11', '2025-09-30 22:44:54', 1, 1);
...
INSERT INTO `paid` (`id`, `sale_id`, `price`, `payment_id`, `client_id`, `date`, `description`, `status`, `created`, `updated`, `register_id`, `modify_id`) VALUES
                                                                                                                                                                (1, 2, '800000.00', 1, 2, '2025-09-29', NULL, -1, '2025-09-29 16:06:22', '2025-09-29 16:06:22', 1, 1),
                                                                                                                                                                (2, 2, '10000.00', 1, 2, '2025-09-29', '', -1, '2025-09-29 16:45:32', '2025-09-29 16:45:32', 1, 1),
                                                                                                                                                                (3, 2, '800000.00', 2, 2, '2025-09-30', '', 1, '2025-09-30 14:59:51', '2025-09-30 14:59:51', 1, 1),
                                                                                                                                                                (4, NULL, '100000.00', 1, 2, '2025-09-30', '', -1, '2025-09-30 15:52:29', '2025-09-30 15:52:29', 1, 1),
                                                                                                                                                                (5, NULL, '500000.00', 2, 2, '2025-09-30', '', 1, '2025-09-30 18:48:43', '2025-09-30 18:48:43', 1, 1),
                                                                                                                                                                (6, NULL, '60000.00', 1, 2, '2025-09-30', NULL, 1, '2025-09-30 18:59:11', '2025-09-30 18:59:11', 1, 1),
                                                                                                                                                                (7, NULL, '20000.00', 1, 2, '2025-09-30', NULL, -1, '2025-09-30 18:59:39', '2025-09-30 18:59:39', 1, 1);
...
--
-- Dumping data for table `paid_other`
--

INSERT INTO `paid_other` (`id`, `type`, `group_id`, `description`, `paid_date`, `payment_id`, `price`, `status`, `created`, `updated`, `register_id`, `modify_id`) VALUES
                                                                                                                                                                       (1, 'INCOME', 1, '', '2025-09-30', 1, '700000.00', -1, '2025-09-30 19:29:01', '2025-09-30 19:32:00', 1, 1),
                                                                                                                                                                       (2, 'INCOME', 1, '', '2025-09-30', 1, '800000.00', 1, '2025-09-30 22:38:13', '2025-09-30 22:38:13', 1, 1);
...
--
-- Dumping data for table `paid_worker`
--

INSERT INTO `paid_worker` (`id`, `worker_id`, `date`, `price`, `description`, `payment_id`, `status`, `created`, `updated`, `register_id`, `modify_id`, `sale_id`) VALUES
(1, 1, '2025-09-30', '200000.00', '', 1, 1, '2025-09-30 18:41:49', '2025-09-30 18:41:49', 1, 1, NULL),
(2, 1, '2025-09-30', '150000.00', '', 1, -1, '2025-09-30 18:42:18', '2025-09-30 18:43:02', 1, 1, NULL),
(4, 1, '2025-09-30', '100000.00', '', 1, -1, '2025-09-30 19:19:41', '2025-09-30 19:21:27', 1, 1, NULL);
...
(1, '2025-09-28', '251', 1, 2, 1, '4400000.00', '0.00', '0.00', 1, 'NEW', '2025-09-28 16:53:16', '2025-09-29 11:47:14', 1, 1, 1, '0.00', '220.00', 'Urganch shahar IT Park binosi', '20000.00', '100.00', '1200000.00', NULL, '0.00'),
(2, '2025-09-28', '252', 2, 2, 1, '1960000.00', '0.00', '0.00', 1, 'DONE', '2025-09-28 18:49:36', '2025-09-29 11:48:46', 1, 1, 1, '98.00', '120.00', 'Test', '20000.00', '100.00', '1200000.00', '18000.00', '1200000.00');
...
(7, 2, 1, 'COMPLETED', '2025-09-29 11:45:54'),
(8, 2, 1, 'COMPLETED', '2025-09-29 11:46:41'),
(9, 2, 1, 'COMPLETED', '2025-09-29 11:48:46');
...
INSERT INTO `worker` (`id`, `name`, `phone`, `description`, `image`, `status`, `created`, `updated`, `register_id`, `modify_id`, `balance`) VALUES
                                                                                                                                                (1, 'Dilmurod', '(99) 967-03-95', '', 'avatar/1758966552.7765.jpg', 1, '2025-09-27 14:46:50', '2025-09-30 19:21:27', 1, 1, '1000000.00'),
