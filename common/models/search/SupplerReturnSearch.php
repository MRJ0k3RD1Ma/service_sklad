...
/**
 * SupplerReturnSearch represents the model behind the search form of `common\models\SupplerReturn`.
 */
class SupplerReturnSearch extends SupplerReturn
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SupplerReturn::find()->orderBy(['id' => SORT_DESC]);
