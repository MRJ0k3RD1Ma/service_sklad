...
<div class="goods-group-index">
    <div class="card">
        <div class="card-body">
            ...
            <p>
                <button class="btn btn-success md-btncreate" value="<?= Yii::$app->urlManager->createUrl(['/cp/service-group/create'])?>" type="button">Xizmat turi qo'shish</button>
            </p>
...
//                    'name',
                    [
                        ...
                        'value'=>function($model){
                            $url = Url::toRoute(['/cp/service-group/view', 'id' => $model->id]);
