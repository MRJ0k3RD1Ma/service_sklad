...
<li>
    ...
    <li>
        <a href="<?= Yii::$app->urlManager->createUrl(['/cp/visit'])?>" class="dropdown-toggle no-arrow <?= (Yii::$app->controller->id == 'visit' and (Yii::$app->controller->action->id == 'repair' or Yii::$app->controller->action->id == 'view')) ? 'active' : ''?>">
            <span class="micon bi bi-gear"></span>
            <span class="mtext">Ta`mirlash</span>
        </a>
    </li>
    ...
    <li class="dropdown">
        ...
        <ul class="submenu">
            <li><a class="<?= (Yii::$app->controller->id == 'visit' and Yii::$app->controller->action->id == 'list') ? 'active' : ''?>" href="<?= Yii::$app->urlManager->createUrl(['/cp/visit/list'])?>">Ta`mirlashlar</a></li>
            <li><a class="<?= (Yii::$app->controller->id == 'visit' and Yii::$app->controller->action->id == 'notprinted') ? 'active' : ''?>" href="<?= Yii::$app->urlManager->createUrl(['/cp/visit/notprinted'])?>">Hozr tugallangan</a></li>
            <li><a class="<?= Yii::$app->controller->id == 'client-car' ? 'active' : ''?>" href="<?= Yii::$app->urlManager->createUrl(['/cp/client-car'])?>">Moshinalar</a></li>
        </ul>
    </li>
...
<li class="dropdown">
    ...
    <ul class="submenu">
        ...
        <li><a class="<?= (Yii::$app->controller->id == 'come' and Yii::$app->controller->action->id == 'index') ? 'active' : ''?>" href="<?= Yii::$app->urlManager->createUrl(['/cp/come/index'])?>">Skladga qabul qilinganlar</a></li>
