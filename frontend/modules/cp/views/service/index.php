...
<div class="goods-index">
    ...
    <div class="card">
        <div class="card-body">
            <p>
                <button class="btn btn-success md-btncreate" value="<?= Yii::$app->urlManager->createUrl(['/cp/service/create'])?>" type="button">Xizmat qo'shish</button>
            </p>
...
//                    'name',
                    [
                        'attribute'=>'name',
                        'value'=>function($d){
                            $url = Url::toRoute(['/cp/service/view','id'=>$d->id]);
...
//                    'group_id',
                    [
                        ...
                        'filter'=>\yii\helpers\ArrayHelper::map(GoodsGroup::find()->where(['status'=>1,'type'=>2])->all(),'id','name'),
                    ],
//                    'unit_id',
                    [
                        'attribute'=>'unit_id',
