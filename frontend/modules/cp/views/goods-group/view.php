    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <p>
                        <button class="btn btn-primary md-btnupdate" value="<?= Yii::$app->urlManager->createUrl(['/cp/goods-group/update','id'=>$model->id])?>">O`zgartirish</button>
                ...
                <div class="col-md-9 table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $key?></td>
                                <td><a href="<?= Yii::$app->urlManager->createUrl(['/cp/goods/view','id'=>$item->id])?>"><?= $item->name?></a></td>
                                <td><?= $item->barcode?></td>
