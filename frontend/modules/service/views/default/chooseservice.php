...
<header class="main-header">
    <div class="custom-container">
        <div class="header-panel">
            <a href="<?= Yii::$app->urlManager->createUrl(['/service/default/addservice','id'=>$visit->id ])?>">
...
<section class="section-b-space" style="padding-top:80px;">
    <div class="custom-container">
        <div class="title">
            <h3><?= $group->name .' turdagi xizmatlarni tanlash'?></h3>
        </div>
            ...
            <?php foreach ($model as $item):?>
                ...
                <div class="col-6">
                    <div class="available-servicemen-box">
                        <a href="<?= Yii::$app->urlManager->createUrl(['/service/default/setservice','id'=>$visit->id,'group_id'=>$item->id,'goods_id'=>$item->id])?>" class="servicemen-img">
                        ...
                        <div class="service-details">
                            <a href="<?= Yii::$app->urlManager->createUrl(['/service/default/setservice','id'=>$visit->id,'group_id'=>$group->id,'goods_id'=>$item->id])?>">
                                <h5><?= $item->name ?></h5>
                            </a>
                            <a href="<?= Yii::$app->urlManager->createUrl(['/service/default/setservice','id'=>$visit->id,'group_id'=>$group->id,'goods_id'=>$item->id])?>" class="btn theme-btn">Qo'shish</a>
                        </div>
                    </div>
                </div>
