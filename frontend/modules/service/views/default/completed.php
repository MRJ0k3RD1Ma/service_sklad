<?php
$this->title="Ta'mirlash tugallangan moshinalar ro'yhati"
?>
...
<header class="main-header">
    <div class="custom-container">
        <div class="header-panel">
            ...
            <h3>Ta'mirlangan moshinalar ro'yhati</h3>
...
<section class="section-b-space section-lg-t-space">
    <div class="custom-container">
        <form class="auth-form mt-0 p-0 bg-transparent" action="<?= Yii::$app->urlManager->createUrl(['/service/default/completed','type'=>$type])?>">
            <div class="form-group mt-0">
                <div class="form-input">
                    <input type="search" name="search" class="form-control search with-filter" id="inputusername"
                           placeholder="Moshina raqami " value="<?= $search?>">
