...
<section class="section-b-space" style="padding-top:80px;">
    <div class="custom-container">
        <div class="title">
            <h3>Mahsulotlar turini tanlang</h3>
        </div>
            ...
            <?php foreach ($model as $item):?>
                ...
                <div class="col-6">
                    <div class="available-servicemen-box">
                        <a href="<?= Yii::$app->urlManager->createUrl(['/service/default/chooseproduct','id'=>$visit->id,'group_id'=>$item->id])?>" class="servicemen-img">
                        ...
                        <div class="service-details">
                            <a href="<?= Yii::$app->urlManager->createUrl(['/service/default/chooseproduct','id'=>$visit->id,'group_id'=>$item->id])?>">
                                <h5><?= $item->name ?></h5>
                            </a>
                            <a href="<?= Yii::$app->urlManager->createUrl(['/service/default/chooseproduct','id'=>$visit->id,'group_id'=>$item->id])?>" class="btn theme-btn">Mahsulot tanlash</a>
                        </div>
                    </div>
                </div>
